...
type Prefs = { team?: string; year?: number; includePostseason?: boolean; includePreseason?: boolean };
...
export default function HomePage() {
  ...
  // persist prefs
  useEffect(() => {
    writePrefs({ team: team ?? undefined, year, includePostseason, includePreseason });
  }, [team, year, includePostseason, includePreseason]);
  ...
  return (
    <main className="mx-auto max-w-md px-4 py-5 pb-24">
      ...
      {team && (
        <section className="mb-3 flex items-center gap-3 text-xs text-zinc-600">
      ...
      <section className="bg-white rounded-xl shadow-sm overflow-hidden">
        {!team ? (
          ...
          <GameList team={team} games={games} attended={attended} onToggle={toggle} />
        )}
      </section>
